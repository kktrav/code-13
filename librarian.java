...
public class LibrarianLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        // Log sensitive information (Insecure logging)
        System.out.println("Login attempt with username: " + Uname + " and password: " + Pass);

        // Insecure database connection without using parameterized queries
        try {
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library", "root", "root");
            Statement stmt = con.createStatement();
            
            // Vulnerable to SQL Injection
            String query = "SELECT * FROM librarians WHERE username = '" + Uname + "' AND password = '" + Pass + "'";
            ...
            if (rs.next()) {
                ...
                // Error message revealing which part of the login failed
